...
def train():
    ...
    data = pd.read_csv('./data/twitter.csv', sep=',', quoting=csv.QUOTE_NONE,
                           names=["label", "message"])
    ...
    training_data, testing_data, label_train, label_test = train_test_split(analysis_data, labels, test_size=.25, random_state=45)
    print(training_data)
